                ...
                <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
                    <div class="mb-1 breadcrumb-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item" href="{{ Route('user/create') }}"><i class="me-1" data-feather="check-square"></i><span class="align-middle">Create User</span></a></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <section id="basic-datatable">
                    ...
                    @foreach($users as $user)
                      <tr>
                        ...
                        <td>{{ $user->role->name }}</td>
                        <td>
                        <a href="{{ Route('user/edit',$user->id)  }}" class="btn btn-icon rounded-circle btn-outline-primary"><i data-feather="edit"></i></a>
                        <a href="{{ Route('user/destroy',$user->id) }}" class="btn btn-icon rounded-circle btn-outline-primary"><i data-feather="trash"></i></a>
                      </td>
                      </tr>
                  @endforeach
                                           </tbody>
