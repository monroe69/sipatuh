                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 mt-2">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="/K3/penerapantable/{{ $penerapan->id }}" class="form form-vertical">
                                        @method('put')
                                        @csrf
                                        <div class="row">
                                            <div class="col-12 ">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select class="form-select" id="no_kriteria"
                                                        name="no_kriteria" required autofocus value="{{ old('no_kriteria',$penerapan->no_kriteria) }}">
                                                        <option >{{ old('no_kriteria',$penerapan->kriteria)}}</option>
                                                ...
                                                {{-- <div class="mb-2">
                                                    ...
                                                    <input type="text" id="keterangan" class="form-control"
                                                        name="keterangan" required autofocus value="{{ old('keterangan',$penerapan->keterangan)}}" placeholder="Keterangan" />
                                                </div> --}}
                                                     <div class="mb-2">
                                                     <label class="form-label" for="sub_kriteria">sub kriteria</label>
                                                    <select class="form-select" id="sub_kriteria"
                                                        name="sub_kriteria"  required autofocus value="{{ old('sub_kriteria',$penerapan->sub_kriteria)}}" placeholder="Keterangan">
                                                        <option value="">{{ old('sub_kriteria',$penerapan->sub_kriteria)}}</option>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select class="form-select" id="level" name="level" required autofocus value="{{ old('level',$penerapan->level)}}">
                                                        <option>{{ old('level',$penerapan->level)}}</option>
