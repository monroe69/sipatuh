                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <select class="form-select" id="sub_kriteria" name="sub_kriteria">
                                                ...
                                                <option value="Menerapkan Ijin Kerja (WP) Tingkat Risiko Sesuai Hasil Risk Assessment Pekerjaan">Menerapkan Ijin Kerja (WP) Tingkat Risiko Sesuai Hasil Risk Assessment Pekerjaan</option>
                                                <option value=" Sistem Proteksi Kebakaran IBPPR"> Sistem Proteksi Kebakaran IBPPR</option>
                                                <option value=" Peralatan Proteksi Kebakaran dan Tanggap Darurat"> Peralatan Proteksi Kebakaran dan Tanggap Darurat</option>
