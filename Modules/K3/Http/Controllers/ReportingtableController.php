...
class ReportingtableController extends Controller
{
    /**
    ...
    {
        $reportingdoc=Reportingdoc::select()->where('reporting_id', $id )->get();
       return view('k3::reporting.lihat',[
       'reportingdocs' => $reportingdoc
       ]);
    }
    ...
    {
        return view('k3::reporting.edit', [
        'reporting'=>Reporting::select()->where('id',$id)->get()->first(),
        ]);
    }
