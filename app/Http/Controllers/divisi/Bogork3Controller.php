...
class Bogork3Controller extends Controller
{
    ...
    public function index()
    {
        ...
        'audits'=> Audit::select()->where('divisi','UPDL BOGOR')->get(),
        'leaderships'=> Leadership::select()->where('divisi','UPDL BOGOR')->get(),
        'penerapans'=> Penerapan::select()->where('divisi','UPDL BOGOR')->get(),
        'safetis'=> Safeti::select()->where('divisi','UPDL BOGOR')->get(),
        'comunications'=> Comunication::select()->where('divisi','UPDL BOGOR')->get(),
        'reportings'=> Reporting::select()->where('divisi','UPDL BOGOR')->get(),
        ]);
    }
